...
%% Environment 'environment' could be defined before here, so use
%% \@ifundefined switcher to avoid the duplicate defining.
...
%% !!!
%% Changed by Dazhi Jiang - 2010-09-20
%% \c@IndexColumns is a new counter, so add its definition here.
