...
\begin{groupplot}[group style={group size=1 by 2},height=6cm,width=12cm, xmode=log]
\nextgroupplot [ymode=log]
\addplot coordinates {(1e0, 1e0) (1e1, 1e-1) (1e2,1e-2)};
\addplot coordinates {(1e0, 1e-2) (1e1, 1e-1) (1e2,1e0)};
\fill [blue] (0.1, 0) circle (2pt);
\nextgroupplot
\addplot coordinates {(1e0, 0) (1e01, -90) (1e02, -180)};
\fill [blue] (1, 0) circle (2pt);
\end{groupplot}

Background
\begin{pgfonlayer}{background}
    \path (-2cm,5.6cm) node (tl) {};
    \path (12cm, -6.4cm) node (br) {};
