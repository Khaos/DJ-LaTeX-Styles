...
%
%
% 2010-05-07	Now I refine this file using my Macbook Pro, add more comments 
%				and more commands.
%				Note that: this is not a standalone file, that is, it has to be
%				used with <DJMathComP.tex>.
%
%
...
% Independent and Identically Distributed, also Independent Identically Distributed
